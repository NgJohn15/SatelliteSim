...
# 4 pth_models/Yolov4_epoch50.pth roboflow/test/aux2_png.rf.d296c26f95ac7f73b9548f54acd42c68.jpg test/_classes.txt
...
if  __name__ == "__main__":
    ...
    # from tool.utils import *
    #
    # # contains the information on bounding boxes
    # boxes = do_detect(model, sized, 0.5, n_classes,0.4, use_cuda)
    #
    # class_names = load_class_names(namesfile)
